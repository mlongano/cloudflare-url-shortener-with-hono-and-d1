// Generated by Wrangler by running `wrangler types` (hash: 04d5bba75d8848ea48173752b63ce7fd)
// Runtime types generated with workerd@1.20250319.0 2025-02-24 
declare namespace Cloudflare {
	interface Env {
		ENV: "development" | "production";
		ALLOWED_ORIGINS: ["http://localhost:3000","http://localhost:5500","http://localhost:5173","http://127.0.0.1:5500"];
